      ...
      <nav className="fixed top-17  z-50 rounded-md  left-0 bottom-0  w-20  border-r bg-white/10 backdrop-blur-md  shadow-xl  text-white border-1 border-blue-700/50 space-y-8">
        <div className="flex flex-col h-full z-[60]  ">
          ...
          <div className="flex-1 flex flex-col h-full ">
            ...
            <div>
              <ul className="px-4 pb-4 text-sm font-medium z-[60] overflow-visible">
                {navsFooter.map((item, idx) => (
                  <li key={idx}>
                    ...
                    >
                      ...
                      <span className="absolute z-[70] left-14 p-1 px-1.5 rounded-md whitespace-nowrap text-xs text-white bg-gray-800 hidden group-hover:inline-block group-focus:hidden duration-150">
                        {item.name}
                      </span>
                    </a>
                  </li>
              ...
              <div className="relative py-4 px-4 border-t">
                <DropdownMenu.Root modal={false}>
                  <DropdownMenu.Trigger  asChild className="outline-none">
                    <Avatar.Root>
                      <Avatar.Image
                        className="w-12 h-12 flex items-center gap-x-4 cursor-pointer rounded-full border-2 border-blue-500 ring-offset-2 ring-gray-800 focus:ring-2 duration-150"
                  ...
                  <DropdownMenu.Portal>
                    <DropdownMenu.Content 
                      align=""
                      className="absolute bottom-0 left-12  w-64 rounded-lg   border-1 border-blue-500 text-sm text-white p-2  bg-white/10 backdrop-blur-md  shadow-xl"
                    >
                      <span className="block text-base text-blue-500/50 p-2">
                        vienna@gmail.com
                      </span>
